...
main:
        push ecx
        mov ecx, res            ;set ecx to the ascii value to be printed 
        ...
        mov eax, [res]          ;reset the value of eax to the value of the current ascii (eax was set to 4 for the print commands)
        ...
        pop ecx
        loop main               ;if eax is less than 91, loop again, but if eax >= 91, continue to exit procedure
        call procExit
